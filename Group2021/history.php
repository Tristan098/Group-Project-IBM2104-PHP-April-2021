      ...
      if ($result != false && $result->num_rows > 0) {
        while($row=$result->fetch_assoc()) {
          ...
          <div class="destination">
            <h6 class="text-light bg-info text-center rounded p-1"><?= $row['destination']; ?></h6>
          </div>
          <p class="details">
            <b>
              ...
              Bus Interval: <?= $row['pickup']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
