...
<head>
  ...
  <link rel="stylesheet" href="\Group2021\style.min.css" type="text/css">
...
<body>
  <header class="header">
    <div class="header_logo">
      <a href="index.php"><img src="\Group2021\image\bus_logo.png" alt="Logo"></a>
    </div>
    <div class="header__nav">

      <span class="line"></span>
      <button class="header__nav__button">
        <a href="history.php"><img src="\Group2021\image\history.svg" style="width:24px; height:24px;" alt="History" /></a>
      </button>
      <span class="line"></span>
    </div>
  </header>
                ...
                <div class="card border-secondary">
                  ...
                  <div class="card-body">
                    ...
                    <p>
                      ...
                      Bus Intereval: <?php echo $row[4] ?><br>
